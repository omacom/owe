...
static void test_kind(void) {
    ...
    CHECK(owe_kind_from_path("a.mpeg") == OWE_KIND_VIDEO, "mpeg is video");
    CHECK(owe_kind_from_path("a.mpg") == OWE_KIND_VIDEO, "mpg is video");
    CHECK(owe_kind_from_path("a.ts") == OWE_KIND_VIDEO, "ts is video");
    CHECK(owe_kind_from_path("a.m2ts") == OWE_KIND_VIDEO, "m2ts is video");
    CHECK(owe_kind_from_path("a.mts") == OWE_KIND_VIDEO, "mts is video");
    CHECK(owe_kind_from_path("a.wmv") == OWE_KIND_VIDEO, "wmv is video");
    CHECK(owe_kind_from_path("a.asf") == OWE_KIND_VIDEO, "asf is video");
    CHECK(owe_kind_from_path("a.flv") == OWE_KIND_VIDEO, "flv is video");
    CHECK(owe_kind_from_path("a.f4v") == OWE_KIND_VIDEO, "f4v is video");
    CHECK(owe_kind_from_path("a.ogv") == OWE_KIND_VIDEO, "ogv is video");
    CHECK(owe_kind_from_path("a.3gp") == OWE_KIND_VIDEO, "3gp is video");
    CHECK(owe_kind_from_path("a.3g2") == OWE_KIND_VIDEO, "3g2 is video");
    CHECK(owe_kind_from_path("a.apng") == OWE_KIND_VIDEO, "apng is video");
    CHECK(owe_kind_from_path("a.TS") == OWE_KIND_VIDEO, "TS is video");
